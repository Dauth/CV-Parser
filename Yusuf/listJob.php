...
<div id="loadParsed" style="font-size:110%">
    ...
    var vala = b.education[key];
             ...
             for(j=0;j<b.experience.length;j++)
             {
                 ...
                 {
                     str = str + "<div class='outer'>" + b.experience[j]["workPosition"] + "</div> - "; 
                 }
                 else
                 {
                 str = str + "<div class='outer'>" + b.experience[j]["workPosition"] + "</div><div class='inner'>" +  b.experience[j]["workDuration"] + "</div> - "; 
                 }
             }
