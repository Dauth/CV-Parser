...
<link rel="stylesheet" type="text/css" href="css/timestack.css" />
<link rel="stylesheet" type="text/css" href="css/popoverStyle.css" />
...
<script src="js/animatedModal.min.js"></script>
    ...
    <script src="js/modalica.js"></script>
...
<title>Resume Processing Platform</title>
<style type="text/css">
...
<body>
    ...
    <div class="span12">
        <div style="font-size: 300%;">XXX Careers</div>
            </div>
        </div>
<div class="rmm">
            <ul>
                <li><a href='#overview'>Upload Resume</a></li>
                <li><a href='#admin'>Upload Job</a></li>
                <li><a href='#listResume'>Resumes</a></li>
                <li><a href='#listJob'>Jobs</a></li>
            </ul>
